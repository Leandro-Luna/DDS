...
import { IngreseDatos, VerifiqueDni } from './componentes'
  ...
  return (
    <div>
        <Routes>
            ...
            <Route exact path='/verPropiedad/:id' element={<ClienteVerPropiedadSni/>}/>
            <Route exact path='/completarFormulario/:id' element={<ClienteCompletarFormularioSni/>}/>
            ...
            <Route exact path='/verPropiedadReg/:id' element={<ClientePagVerPropiedadReg/>}/>
            <Route exact path='/completarFormularioReg/:id' element={<ClienteCompletarFormularioReg/>}/>
            ...
            <Route exact path='/verifiqueDni' element={<VerifiqueDni/>}/>
            <Route exact path='/ingreseDatos/:dni' element={<IngreseDatos/>}/>
            ...
            <Route exact path='/AgenteVerPropiedad/:id' element={<AgenteVerPropiedad2/>}/>
