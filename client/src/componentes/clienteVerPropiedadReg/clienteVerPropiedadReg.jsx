  ...
  return (
    <div className='fondoverpropiedad' >
        <div className='cuadropropiedad'>
              ...
              <Link to='/catalogoReg'><button className='botonDetalle'> Volver al catalogo</button></Link>
            
              <Link to={`/completarFormularioReg/${id}`}><button className='botonDetalle'> Solicitar cita </button></Link>   
              </div>
              </div>
