...
import  '../CatalogoEmp/CatalogoEmp.css'
          ...
          <div className='propiedades'>
                    
                    {
                        propiedadesDB?
                            ...
                            return(
                                < ClientePropiedades key={index} imagen={`http://localhost:3001/${item.cod_inmueble}tpi.png`} cod_inmueble={item.cod_inmueble} estado={item.opcion_contrato} precio={'$'+item.precio}/>
                            )
                            }) 
                        :null
                    }
