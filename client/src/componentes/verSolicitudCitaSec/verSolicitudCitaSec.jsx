                    ...
                    <table className='solicitud-cita-sec-tabla'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button className='solicitud-cita-sec-tabla-modificar' onClick={handleModificarCita}>Modificar solicitud</button ></td>
                                <td><button className='solicitud-cita-sec-tabla-eliminar' onClick={handleEliminarCita}>Eliminar solicitud</button></td>
                            </tr>
                            <tr>
                                <td>99.999.999</td>
                                <td>99/99/9999</td>
