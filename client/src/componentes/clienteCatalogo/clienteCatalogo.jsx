...
import ClientePropiedades from '../clientePropiedades/clientePropiedades'
          ...
          <div className='propiedades'>
                    
                    {
                        propiedadesDB?
                            ...
                            return(
                                < ClientePropiedades key={index} imagen={`http://localhost:3001/${item.cod_inmueble}tpi.png`} cod_inmueble={item.cod_inmueble} ubicacion={`/verPropiedad/${item.cod_inmueble}`} estado={item.opcion_contrato} precio={'$'+item.precio}/>
                            )
                            }) 
                        :null
                    }
                    < ClientePropiedades  imagen={propiedades[0].imagen} cod_inmueble={'999'} estado={propiedades[0].estado}  precio={propiedades[0].precio}/>
